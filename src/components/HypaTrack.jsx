  ...
  return (
    <div className="min-h-screen  p-4 md:p-8 font-sans text-slate-800">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* HEADER SECTION */}
        <div className=" h-125 relative flex flex-col items-center justify-center text-center md:py-40 py-10 px-5">
          <h1 className="text-5xl md:text-9xl font-extrabold tracking-tight text-slate-900 mb-4">
